    ...
    Sub Main()
        ...
        If exito = 0 Then
            strconsulta = "update ase  set ase.arcverrut=af.arcverrut, ase.arcverfec=getdate(), ase.arcvermat=1 " &
                   ...
                   "ase.ArcVerNiv = 3 And ase.ArcVerSub = 1 And ase.ArcVerEmp = 0 And ((ase.ArcVerCod = 1 and ase.arcversec<>15) or (ase.ArcVerCod = 8 and ase.arcversec=15)) And ase.ArcVerRef = ps.ExpCod " &
