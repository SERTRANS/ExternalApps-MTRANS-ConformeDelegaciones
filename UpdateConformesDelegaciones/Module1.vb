...
Module Module1
    ...
    Sub Main()
        ...
        Dim strconsulta As String = "update ase  set ase.arcverrut=af.arcverrut, ase.arcverfec=getdate(), ase.arcvermat=1 " &
                    ...
                    "ase.ArcVerNiv = 3 And ase.ArcVerSub = 1 And ase.ArcVerEmp = 0 and ((ase.ArcVerCod = 1 and (ase.arcversec<>23 OR (ase.ArcVerSec=23 AND Ase.ArcVerCtr<>3))) or (ase.ArcVerCod = 8 AND ASe.ArcVerCtr=3 and ase.arcversec in (15,23,24))) And ase.ArcVerRef = ps.ExpCod " &
